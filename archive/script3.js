...
function updateCalculator() {
  ...
  let etchDepth = parseFloat(document.getElementById('etchDepth').value) || 0.5;
  ...
  if (task === 'etch' && material !== 'aluminium') {
    ...
    if (etchDepth > maxSafeDepth) {
      etchDepth = maxSafeDepth;
      document.getElementById('etchDepth').value = maxSafeDepth.toFixed(2);
